...
const WebExpCard = () => {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed="1.55" className='xs:hidden w-full py-10 z-40 relative rounded-t-[1vw] bg-[#004d43] flex overflow-hidden'>
        <motion.div 
            className='flex'
            initial={{ x: 0 }} 
            animate={{ x: "-136%" }} 
