  ...
  return (
    <div className='flex h-[10vh] justify-between w-full items-center'>
      <h1 className='text-4xl ml-8 font-bold'>
        <i className='font-mono text-red-700 flex'>
          Murtaza <p className='text-white'>.</p> <p className='text-blue-500'>Dev</p>
        </i>
      </h1>
      <div className='text-white w-[60%] justify-evenly flex items-center'>
        <Link to="home" smooth={true} duration={2000} className='hover:border-b-4 hover:border-yellow-400 py-2 rounded cursor-pointer'>Home</Link>
