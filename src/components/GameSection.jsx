    ...
    <div id='GameSection' className='min-w-full min-h-[100vh] xs:min-h-[60vh] text-white mt-[20vh] xs:mt-[38vh] items-center justify-center '>
      ...
      <div className='p-10 '>
            ...
            <div className='mt-[12vh] flex flex-col items-center justify-between gap-[10vw] '>
                ...
                <motion.div  whileHover={{opacity:0 ,scale:1.01}} initial={{opacity:1}} className='flex xs:text-red-700 items-center justify-center text-4xl font-bold font-danfo absolute w-[40vw] h-[60vh] xs:w-[52vw]  bg-black z-40 h-full z-index-30 '>SIMON SAYS</motion.div>
